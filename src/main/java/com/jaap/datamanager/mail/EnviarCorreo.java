...
public class EnviarCorreo {
	...
	public static void enviarCorreo() {
		try {
			...
			props.setProperty("mail.smtp.user", Constantes.CORREO_ORIGEN);
			...
			message.setFrom(new InternetAddress( Constantes.CORREO_ORIGEN ));
			...
			t.connect(Constantes.CORREO_ORIGEN, Constantes.CONTRASENIA_ORIGEN);
